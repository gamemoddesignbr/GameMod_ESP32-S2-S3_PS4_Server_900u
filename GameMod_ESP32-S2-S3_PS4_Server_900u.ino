...
IPAddress WIFI_PDNS(8, 8, 8, 8);
IPAddress WIFI_SDNS(8, 8, 4, 4);
      ...
      if (FILESYS.begin(SS, SPI)) {
         ...
         if (connectWifi && WIFI_SSID.length() > 0 && WIFI_PASS.length() > 0) {
            ...
            if (useWF) {
               ...
               //        else
               //            HWSerial.println("Configure WiFi succeeded!");
            }
